...
let carrosUpgrade = [
    {
        joaoUp: {
            car: {
                velMax: 0, velMin: 0, derrapagem: 0,
            },
            points: 4,
            nivel: "5",
        }
...
function pontos (item) {
    ...
    item.joaoUp.points += 1;
    console.log(item.joaoUp.points);
    //console.log(indice);
    //console.log(array);
}


//console.log(carrosUpgrade[0].joaoUp.points);
//console.log(joaoCarVelMax*2);
carrosUpgrade.forEach(pontos);
//console.log(carrosUpgrade[0].joaoUp.car.velMax);
